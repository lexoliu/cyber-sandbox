#!/bin/bash
# Generated by cyber-sandbox. Applied once, as root, before CAP_NET_ADMIN is dropped.
#
...
ip6tables -I OUTPUT 2 -j NFLOG --nflog-group "${NFLOG_GROUP}" --nflog-prefix "cyber-sandbox-blocked6"
